...
<header class="wp-block-group alignfull basse-pattern-hero-basic-1 has-neutral-50-background-color has-background" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)">
    ...
    <h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Our latest blog articles', THEME_NS ) ?></h1>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|small"}}},"fontSize":"medium"} -->
    <p class="has-text-align-center has-medium-font-size" style="margin-top:var(--wp--preset--spacing--small)"><?php esc_html_e( 'Learn the latest and greatest in WordPress site building. Checkout tutorials, tips and tricks, and video walkthroughs on our blog.', THEME_NS ) ?></p>
    <!-- /wp:paragraph -->
</header>
<!-- /wp:group -->