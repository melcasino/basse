...
<main class="wp-block-group" style="min-height:100vh;padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)">
    ...
    <div class="wp-block-group">
        ...
        <h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Page not found', THEME_NS ) ?></h1>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"align":"center"} -->
        <p class="has-text-align-center"><?php esc_html_e( 'Sorry, the page you are looking for doesn’t exist or has been moved. Kindly go back to the ', THEME_NS ) ?><a href="<?php echo esc_url( home_url( '/' ) ); ?>" data-type="page"><?php esc_html_e( 'homepage', THEME_NS ) ?></a><?php esc_html_e( ' or try searching.', THEME_NS ) ?></p>
        <!-- /wp:paragraph -->
